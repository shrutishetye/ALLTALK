...
#Region "FIELDS AND OBJECTS"
    ...
    Private Shared _UserState As New UserState
...
#Region "HELPER METHODS"
    ...
    Private Sub LogMessage(_Message As String, ParamArray _Args As Object())
        ...
        MessageBox.Show(String.Format(_Message, _Args))
...
#Region "PACKET SENDERS"
    ...
    Public Sub SendRegisterPacket(_FName As String, _LName As String, _Email As String)

        SendPacket(CByte(PacketHeader.Register), _FName, _LName, _Email)
